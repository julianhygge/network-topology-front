        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 bg-gray-100 rounded-xl p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                {bill_details.policy_type === "GROSS_METERING" && (
                  <>
                    <div className="flex justify-between items-center border-b border-gray-200">
                      <span className="text-sm text-gray-600">
                        Retail Charges ({formatNumber(total_energy_imported_kwh)} kWh @ ₹{formatNumber(bill_details.import_retail_price_per_kwh)}/kWh)
                      </span>
                      <span className="font-medium text-gray-800">
                    ...
                    <div className="flex justify-between items-center border-b border-gray-200">
                      <span className="text-sm text-gray-600">
                        Wholesale Charges ({formatNumber(total_energy_exported_kwh)} kWh @ ₹{formatNumber(bill_details.exp_whole_price_kwh)}/kWh)
                      </span>
                      <span className="font-medium text-gray-800">
                ...
                <div className="flex justify-between items-center border-b border-gray-200">
                  ...
                  <span className="font-medium text-gray-800">₹ {formatNumber(bill_details.tax_amount_on_energy)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg p-4 flex items-center justify-between">
              ...
              <div>
                <p className="text-2xl font-bold">₹ {formatNumber(calculated_bill_amount)}</p>
              </div>
            </div>
          </div>
        </div>
