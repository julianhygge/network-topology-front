...
import { generateTouMeteringPolicyBill } from 'services/netMeteringService'
...
const TimeOfUseMeteringBillPage = () => {
    ...
    const handleAddRow = () => {
        setRows([...rows, {id: rows.length + 1, startTime: "00:00", endTime: "00:00", retail: 0, wholesale: 0 }]);
    };
                ...
                <div className="flex flex-1 flex-col items-center justify-center bg-[#E7FAFF]">
                    ...
                    <div className="w-full max-w-[1560px] py-6 px-6 md:px-20 bg-white border-2 border-[#BF6A02] rounded-2xl shadow-lg mx-4 relative">
                        ...
                        <div className="absolute top-5 right-16">
                            ...
                            disabled={!isReadOnly}
                            >
                                <img src="/images/Icon.svg" alt="Edit" className="w-6 h-6 hover:opacity-70"/>
                            </button>
                        </div>
                        {/* Close button */}
                        ...
                        Please select the time period and enter the retail and wholesale amount
                        </div>
                            ...
                            <div key = {index}>
                                <div className="grid grid-cols-5 gap-10 items-center px-4 mb-6">
                                    ...
                                    <div className="flex justify-center items-center">   
                                        ...
                                        onChange={(e) => handleChange(index, "retail", e.target.value)}
                                        readOnly={isReadOnly}
                                    ...
                                    <div className="flex justify-center items-center"> 
                                        ...
                                        onChange={(e) => handleChange(index, "wholesale", e.target.value)}
                                        readOnly={isReadOnly}
                                        className="w-[9rem] px-3 py-2 border rounded-xl text-lg placeholder:text-lg mr-5 font-medium"
                                        />
                                    </div> 
                                </div>
                                <div className="border-b border-gray-300 mx-4 mb-6 mr-20"></div> {/* horizontal line */}
                            </div>
                            ))}
                        </div>
