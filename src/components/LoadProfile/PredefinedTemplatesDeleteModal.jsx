...
const PredefinedTemplatesDeleteModal = ({ onConfirm, onCancel }) => {
  return (
        ...
        <div className="flex flex-col items-center pb-14 pt-2 max-md:pr-5 max-md:max-w-full">
          <div className="flex flex-col">
            <div className="mt-28 text-center max-md:mt-10">
              Are you sure to Delete the Load Profile Data <br />
              of the Pre Defined Template ?
            </div>
          </div>
...
export default PredefinedTemplatesDeleteModal;
