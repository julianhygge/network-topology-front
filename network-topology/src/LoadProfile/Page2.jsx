  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-[#E7FAFF]">
      ...
      <div className="flex flex-col items-center w-[50vw] px-10 pt-10 pb-20 font-medium text-center text-navColor bg-white rounded-2xl max-w-[860px] shadow-[0px_5px_10px_rgba(169,218,198,1)] max-md:px-5">
        <button className="self-start text-xl max-md:max-w-full">BACK</button>
        <div className="mt-20 text-xl w-[300px]  max-md:mt-10">
          Please browse and upload the <br /> 15 Min data load profile .csv file
          from your computer
        </div>
        <div className="flex gap-8 justify-between mt-20 max-w-full text-xl tracking-normal text-[background: #204A56] whitespace-nowrap max-md:mt-10">
