...
const Delete = ({ onConfirm, onClose, entityId, entityName, entityType }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="relative flex flex-col justify-center px-1 text-xl font-medium text-orange-600 w-[700px] max-w-[700px] bg-white rounded-3xl border border-sky-400 border-solid shadow-sm z-10">
      <div className="absolute inset-0 top-4 -z-10 text-[16px] text-black font-light">
        <Breadcrumb nodeId={entityId}/>
      </div>
